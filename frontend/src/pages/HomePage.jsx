  ...
  return (
    <PageTransition>
      ...
      <div className="min-h-screen">
        ...
        {/* Features Section */}
        <section ref={featuresRef} className="py-20 bg-white dark:bg-black transition-colors duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`text-center mb-16 transition-all duration-1000 ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Why Choose Rentify?</h2>
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">Experience the future of renting with our innovative platform</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div
                  key={feature.title}
                  className={`text-center p-8 rounded-2xl bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 hover:from-primary-50 hover:to-primary-100 dark:hover:from-gray-800 dark:hover:to-gray-700 transition-all duration-500 hover-lift group ${featuresVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                  style={{ transitionDelay: `${index * 200}ms` }}
                >
                  <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300 ${feature.color}`}>
                    <feature.icon className="w-8 h-8" />
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 group-hover:text-primary-700 dark:group-hover:text-primary-400 transition-colors duration-300">
                    {feature.title}
                  </h3>
        ...
        {/* Featured Listings */}
        <section ref={listingsRef} className="py-16 bg-white dark:bg-black transition-colors duration-300">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className={`flex justify-between items-center mb-8 transition-all duration-1000 ${listingsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300">Discover popular items in your area</p>
              </div>
              <Link
                to="/listings"
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {nearbyLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">No nearby listings</h3>
                <p className="text-gray-600 dark:text-gray-300">Try expanding your search distance or explore all listings.</p>
              </div>
            )}
          </div>
        </section>
