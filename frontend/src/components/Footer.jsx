        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition-colors">
                ...
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path fillRule="evenodd" d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.014 5.367 18.647.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.418-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928.875 1.418 2.026 1.418 3.323s-.49 2.448-1.418 3.244c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.781h-1.68c-.928 0-1.68-.752-1.68-1.68V3.846c0-.928.752-1.68 1.68-1.68h1.68c.928 0 1.68.752 1.68 1.68v1.681c0 .928-.752 1.68-1.68 1.68z" clipRule="evenodd" />
                </svg>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/listings/new" className="text-gray-400 hover:text-white transition-colors">
                  List Your Item
                </Link>
              </li>
              <li>
